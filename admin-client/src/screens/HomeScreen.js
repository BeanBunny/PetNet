    ...
    return (
        <Card>
            <Card.Content>
                ...
                <Paragraph>
                    PVMC Registraion: {JSON.stringify(pvmc_reg)}
                </Paragraph>
            </Card.Content>
            <Card.Actions>
                <Button
                    onPress={() =>
                        AcceptAlert(req, entireList, updateList, navigation)
                    }
                >
                    Accept
                </Button>
                <Button
                    onPress={() => RejectAlert(req, entireList, updateList)}
                >
                    {" "}
                    Reject
                </Button>
